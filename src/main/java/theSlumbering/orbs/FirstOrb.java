...
import theSlumbering.vfx.CustomOrbPassiveEffect;

import static theSlumbering.SlumberingMod.makeOrbPath;
...
public class FirstOrb extends AbstractOrb {
    ...
    private static final Texture IMG = TextureLoader.getTexture(makeOrbPath("orb.png"));
    ...
    public void updateDescription() {
        applyFocus();
        description = DESC[0] + passiveAmount + DESC[2];
    }
    ...
    public void updateAnimation() {
        ...
        if (vfxTimer < 0.0f) {
            AbstractDungeon.effectList.add(new CustomOrbPassiveEffect(cX, cY));
