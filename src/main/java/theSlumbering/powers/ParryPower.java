...
public class ParryPower extends AbstractPower implements CloneablePowerInterface, OnLoseBlockPower {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("parry_power84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("parry_power32.png"));
