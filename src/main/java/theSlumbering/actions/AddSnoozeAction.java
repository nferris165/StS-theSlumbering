...
public class AddSnoozeAction extends AbstractGameAction {

    private AbstractPlayer p;
    public static final String ACTION_ID = SlumberingMod.makeID("AddSnoozeAction");
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString(ACTION_ID);
    private static final String[] TEXT = uiStrings.TEXT;

    private ArrayList<AbstractCard> cannotUpgrade = new ArrayList<>();

    public AddSnoozeAction() {
