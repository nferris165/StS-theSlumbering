...
import theFirst.powers.CommonPower;

public class TestPowerAction extends AbstractGameAction {
    ...
    public TestPowerAction(final AbstractPlayer p, final AbstractMonster m,
